        ...
        <div class="squad-grid">
          ${groups[pos].map(p => `
            <div class="player-card">
              <div class="photo">${p.photo ? `<img src="${p.photo}" alt="${p.name}" loading="lazy" style="--photo-pos:${p.photoPos || 'center'}${p.photoPosMobile ? `; --photo-pos-mobile:${p.photoPosMobile}` : ''}" />` : initials(p.name)}</div>
              <div class="info">
